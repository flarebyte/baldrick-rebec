...
func (s *Service) handleCreate(srv interface{}, ctx context.Context, dec func(interface{}) error, _ grpc.UnaryServerInterceptor) (any, error) {
    ...
    if tc.Created.Valid { out.Created = tc.Created.Time.Format("2006-01-02T15:04:05.999999999Z07:00") }
    return out, nil
}
...
func (s *Service) handleList(srv interface{}, ctx context.Context, dec func(interface{}) error, _ grpc.UnaryServerInterceptor) (any, error) {
    ...
    if s.DB == nil { return nil, fmt.Errorf("testcase service not initialized") }
    limit := int(in.Limit)
    ...
    for _, t := range items {
        ...
        if t.Created.Valid { it.Created = t.Created.Time.Format("2006-01-02T15:04:05Z07:00") }
