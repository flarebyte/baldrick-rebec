...
// PromptServiceServer is the interface used by gRPC registration to validate implementations.
type PromptServiceServer interface {
	Run(context.Context, *PromptRunRequest) (*PromptRunResponse, error)
}
