...
var getCmd = &cobra.Command{
    ...
    RunE: func(cmd *cobra.Command, args []string) error {
        if strings.TrimSpace(flagTopicGetName) == "" { return errors.New("--name is required") }
        if strings.TrimSpace(flagTopicGetRole) == "" { return errors.New("--role is required") }
        ...
        if t.Description.Valid && t.Description.String != "" { out["description"] = t.Description.String }
        if t.Notes.Valid && t.Notes.String != "" { out["notes"] = t.Notes.String }
