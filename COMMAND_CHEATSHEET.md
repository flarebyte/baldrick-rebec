...
| `rbc blackboard sync`   | Sync blackboard and stickies id ↔ folder                                   | `id:<uuid> folder:<rel>`, `--dry-run`, `--delete`, `--clear-ids`, `--force-write`, `--include-archived`, id:`_` shortcut | `rbc blackboard sync id:_ folder:notes`                         |
| `rbc blackboard diff`   | Show differences between id and folder                                     | `id:<uuid> folder:<rel>`, `--detailed`, `--include-archived`, id:`_` shortcut                                      | `rbc blackboard diff id:_ folder:notes --detailed`             |
| `rbc blackboard import` | Import blackboard+stickies from folder (IDs preserved)                     | `<folder>`, `--detailed` (shows preview)                                                                           | `rbc blackboard import notes`                                    |
...
| `rbc project sync`  | Export project to folder           | `name:<text> folder:<rel>`, `--role`, `--dry-run`                                                                                                  | `rbc project sync name:acme/complete folder:projects --role user`                         |
| `rbc project sync`  | Import project from folder         | `folder:<rel> name:<text>`, `--dry-run`                                                                                                            | `rbc project sync folder:projects-import name:acme/complete`                               |
