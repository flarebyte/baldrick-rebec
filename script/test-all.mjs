...
try {
  ...
  try {
    ...
    try {
      const r = await $`buf curl --http2-prior-knowledge -H 'Content-Type: application/connect+json' --data '{"tool_name":"ollama-gemma","input":"Ping"}' http://127.0.0.1:53051/prompt.v1.PromptService/Run`;
